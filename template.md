...
-   `col_names`: usually TRUE. If FALSE, column names are X1, X1, … .
    You can also supply column names.
-   `na`: string vector containing character expressions for missing
    values.
...
The following code can replace all the number 19 in the dataset with
`NA`
